  ...
  return (
    <section id="download" className="py-24 px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-12 items-center relative z-10">
            ...
            <div>
              <div className="flex items-center gap-6 mb-8">
                <div className="w-24 h-24 rounded-3xl overflow-hidden shadow-2xl shadow-blue-500/25">
                  <Image
                    src={`${process.env.NODE_ENV === 'production' && process.env.GITHUB_ACTIONS ? '/toneforge-landing' : ''}/toneforge-icon.png`}
                    alt="ToneForge Icon"
                    width={96}
                    height={96}
                ...
                <div>
                  ...
                  <p className="text-gray-300 text-lg">Versão 1.0</p>
                </div>
              </div>
            ...
            <div className="space-y-6">
              {/* Primary Download */}
              <motion.a
                href="https://github.com/ThiagoRech1997/ToneForge/releases/latest"
                target="_blank"
                rel="noopener noreferrer"
                whileHover={{ scale: 1.02, y: -4 }}
                whileTap={{ scale: 0.98 }}
                className="group w-full relative overflow-hidden bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white shadow-2xl hover:shadow-blue-500/25 transition-all duration-300 block"
              >
                <div className="relative z-10 flex items-center justify-between">
                  <div className="flex items-center gap-6">
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-blue-100">Android 8.1+</div>
                    </div>
                  </div>
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="group w-full border-2 border-gray-600 hover:border-gray-500 rounded-2xl p-6 text-white hover:bg-gray-800/50 transition-all duration-300 block"
              >
        ...
        {/* Installation Guide - full width */}
        <motion.div
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className="bg-gray-800/60 backdrop-blur-sm rounded-3xl p-8 border border-gray-700/40 max-w-3xl mx-auto"
        >
